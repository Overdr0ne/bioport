...
#elif defined ZEPHYR
/* #define MPL_LOGI(fmt, ...) LOG_INF(fmt, ##__VA_ARGS__) */
#define MPL_LOGI(fmt, ...) printk(fmt, ##__VA_ARGS__)
#else
...
#elif defined ZEPHYR
/* #define MPL_LOGW(fmt, ...) LOG_WRN(fmt, ##__VA_ARGS__) */
#define MPL_LOGW(fmt, ...) printk(fmt, ##__VA_ARGS__)
#else
...
#elif defined ZEPHYR
/* #define MPL_LOGE(fmt, ...) LOG_ERR(fmt, ##__VA_ARGS__) */
#define MPL_LOGE(fmt, ...) printk(fmt, ##__VA_ARGS__)
#else
